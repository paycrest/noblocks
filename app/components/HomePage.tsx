...
import { blurReveal } from "./AnimatedComponents";
      ...
      <div className="w-full">
        ...
        >
          ...
          {(() => {
            ...
            return (
              <div className="grid grid-cols-1 gap-6 sm:border-[#EBEBEF] md:rounded-[28px] md:border md:p-6 md:dark:border-[#FFFFFF1A] lg:grid-cols-2 lg:gap-8">
