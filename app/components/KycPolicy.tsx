...
export const KycPolicy = () => {
  return (
    <div className="mt-4 space-y-4 text-justify text-sm font-normal leading-5 dark:text-[#FFFFFF80]">
      ...
      <p>
        We collect corporate documents, business identifiers, representative information, beneficial
      ...
      <p>
        ...
        Paycrest&apos;s systems, detecting and preventing fraud or misuse of services, monitoring
        transactions for illicit activity, improving the performance and functionality of
        Paycrest&apos;s products, and conducting internal analytics and risk assessments.
      </p>
      <p>
        5.2. We may rely on consent as a lawful basis where consent is expressly required under
        applicable law. Where processing is based on consent, the data subject retains the right to
        withdraw such consent at any time, without affecting the lawfulness of processing carried out
        prior to withdrawal.
      </p>
      ...
      <p>
        ...
        data protection laws, and We ensure that Personal Data is used solely for the purposes for
      ...
      <p>
        8.3. By using our Service, you acknowledge that while we strive to implement robust security
        measures, you are ultimately responsible for your wallet&apos;s security and for any
      ...
      <p>
        ...
        outlined in this Privacy Policy, including compliance with legal obligations and the
        resolution of disputes. Once the data is no longer required for these purposes, we will
      ...
      <p>
        ...
        third-party providers are independent entities with their own privacy practices, we partner
        only with entities that comply with relevant data protection laws. However, we do not control
        the data collection practices of these third parties and are not responsible for their
        privacy policies or practices. We encourage you to review their privacy policies to
        understand how your information is handled.
      </p>
      <p>12.2 Information Collection by Third Parties</p>
      <p>
        When you interact with third-party applications through our service, they may request
        personal information such as your name, email address, or payment details. This information
        is collected and processed by the third party, not by us. We recommend reviewing the privacy
        policies of any third-party services you use to understand how your information will be
        handled.
      </p>
      <p>12.3 Cookies and Tracking Technologies</p>
      <p>
        Third-party applications may use cookies, web beacons, or other tracking technologies to
        collect information about your online activity. These technologies help third parties
        analyze usage patterns, deliver personalized content, and improve their services. You have
        the option to manage your cookie preferences through your browser settings or the
        third-party&apos;s privacy settings.
      </p>
      <p>12.4 Data Sharing with Third Parties</p>
      <p>
        We may share limited data, such as wallet addresses or transaction details, with third-party
        providers to facilitate the services offered through our platform. However, any personal
        information collected by these third parties is governed by their privacy policies, not
        ours.
      </p>
      <p>12.5 Your Responsibility</p>
      <p>
        It is your responsibility to review and understand the privacy practices of any third-party
        applications or services you engage with through our platform. We encourage you to contact
        the third parties directly if you have any concerns about how your information is being
        handled.
      </p>
      ...
      <p>
        ...
        providers to understand how their child&apos;s data might be handled.
      </p>
      <p>
        13.3 If we become aware that we have inadvertently received personal information from a
        child without parental consent, we will take steps to delete such information from our
        records. If you believe that a child under 18 has provided us with personal information,
        please contact us at{" "}
        <Link href="mailto:legal@paycrest.io" className="font-bold text-blue-500">
          legal@paycrest.io
        </Link>
      ...
      <p>
        ...
        cryptocurrency transactions with human oversight, ensuring that while automation aids in
        processing, key decisions and any complex issues are reviewed and monitored by our team to
        provide a fair and secure experience.
      </p>
      <p>
      ...
      <p>
        ...
        changes by posting the updated policy on our website and indicating the effective date.
        Please review this Privacy Notice regularly to ensure that you are aware of its terms. Your
        continued use of our service after the effective date constitutes your acceptance of the
        updated policy.
      </p>
