export const baseBtnClasses =
  "text-sm min-w-fit leading-none min-h-11 rounded-xl px-4 py-2.5 font-medium transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-lavender-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed dark:focus-visible:ring-offset-neutral-900";
...
export const whiteBtnClasses = `${baseBtnClasses} bg-white text-text-body shadow hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 disabled:bg-gray-200 disabled:text-gray-400`;
