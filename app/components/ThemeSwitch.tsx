...
export const ThemeSwitch = () => {
  ...
  return (
    <div className="flex h-11 items-center justify-between gap-6 rounded-full border border-border-light p-1 transition-all dark:border-white/10 dark:bg-surface-canvas">
      <IconButton
