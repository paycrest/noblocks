...
export const ThemeSwitch = () => {
  ...
  return (
    <div className="flex h-11 items-center justify-between gap-2 rounded-full border border-border-light p-1 transition-all dark:border-white/10 max-sm:dark:bg-surface-canvas">
      <IconButton
