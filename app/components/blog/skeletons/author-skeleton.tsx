...
const BlogPostAuthorSkeleton: React.FC = () => (
  <motion.section
    className="mx-auto mb-8 mt-8 flex w-full max-w-2xl animate-pulse items-center gap-4 rounded-xl bg-[#181A20] p-4 shadow-sm"
    variants={fadeBlur}
    initial="initial"
    animate="animate"
    role="status"
  ...
  >
    ...
    <div>
      <div className="mb-2 h-4 w-32 rounded-sm bg-gray-700" aria-hidden="true" />
      <div className="h-3 w-24 rounded-sm bg-gray-700" aria-hidden="true" />
    </div>
  </motion.section>
);
