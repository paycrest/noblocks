  ...
  >
    ...
    <div className="mb-8 flex w-full animate-pulse flex-col overflow-hidden rounded-xl bg-[#181A20] shadow-lg md:flex-row">
      ...
      <div className="flex flex-1 flex-col justify-between p-6">
        <div>
          <div className="mb-3 h-3 w-24 rounded-sm bg-gray-700" />
          <div className="mb-4 h-7 w-3/4 rounded-sm bg-gray-700" />
          <div className="mb-4 h-4 w-2/3 rounded-sm bg-gray-700" />
        </div>
        <div className="mt-2 h-3 w-20 rounded-sm bg-gray-700" />
      </div>
    </div>
  </motion.div>
);
